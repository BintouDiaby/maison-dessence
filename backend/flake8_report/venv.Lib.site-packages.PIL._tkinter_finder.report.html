...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\PIL\_tkinter_finder.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.PIL._tkinter_finder.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.PIL._tkinter_finder.source.html#l17">
                  <tt><i>17</i>     <span class="c1"># not available. load_tkinter_funcs will check the binary first in any case.</span></tt>
               </a>
            </li>
            </ul>
         </li>
