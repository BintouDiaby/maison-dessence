...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\anyio\_core\_testing.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.anyio._core._testing.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.anyio._core._testing.source.html#l50">
                  <tt><i>50</i> <span class="sd">        Return ``True`` if the task has a cancellation pending, ``False`` otherwise.</span></tt>
               </a>
            </li>
            </ul>
         </li>
