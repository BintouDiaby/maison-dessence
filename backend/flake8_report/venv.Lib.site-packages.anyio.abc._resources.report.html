...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\anyio\abc\_resources.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.anyio.abc._resources.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.anyio.abc._resources.source.html#l14">
                  <tt><i>14</i> <span class="sd">    Works as an asynchronous context manager which returns the instance itself on enter,</span></tt>
               </a>
            </li>
            </ul>
         </li>
