...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\anyio\abc\_subprocesses.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.anyio.abc._subprocesses.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.anyio.abc._subprocesses.source.html#l62">
                  <tt><i>62</i> <span class="sd">        The return code of the process. If the process has not yet terminated, this will</span></tt>
               </a>
            </li>
            </ul>
         </li>
