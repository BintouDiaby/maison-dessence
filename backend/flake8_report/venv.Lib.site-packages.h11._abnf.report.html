...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\h11\_abnf.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.h11._abnf.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.h11._abnf.source.html#l131">
                  <tt><i>131</i>     <span class="c1"># we are lenient with trailing whitespaces because some servers on the wild use it.</span></tt>
               </a>
            </li>
            </ul>
         </li>
