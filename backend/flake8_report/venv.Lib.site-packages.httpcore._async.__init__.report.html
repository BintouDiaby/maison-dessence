...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\httpcore\_async\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.httpcore._async.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.httpcore._async.__init__.source.html#l26">
                  <tt><i>26</i>                 <span class="s2">&quot;Attempted to use SOCKS support, but the `socksio` package is not &quot;</span></tt>
               </a>
            </li>
            </ul>
         </li>
