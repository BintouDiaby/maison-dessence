      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy._core.tests.test__exceptions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy._core.tests.test__exceptions.source.html#l15">
                  <tt><i>15</i> <span class="k">class</span><span class="w"> </span><span class="nc">TestArrayMemoryError</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
