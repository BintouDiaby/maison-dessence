      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.core._multiarray_umath.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.core._multiarray_umath.source.html#l41">
                  <tt><i>41</i>         <span class="c1"># Also print the message (with traceback).  This is because old versions</span></tt>
               </a>
            </li>
            </ul>
         </li>
