      ...
      <div id="page">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.f2py.tests.test_array_from_pyobj.source.html#l26">
                  <tt><i>26</i> <span class="k">def</span><span class="w"> </span><span class="nf">setup_module</span><span class="p">():</span></tt>
               </a>
            </li>
            </ul>
         </li>
