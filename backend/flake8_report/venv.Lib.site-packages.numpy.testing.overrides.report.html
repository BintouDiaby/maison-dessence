      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.testing.overrides.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.testing.overrides.source.html#l70">
                  <tt><i>70</i> <span class="k">def</span><span class="w"> </span><span class="nf">allows_array_function_override</span><span class="p">(</span><span class="n">func</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
