...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\openai\_extras\pandas_proxy.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.openai._extras.pandas_proxy.source.html">
         ...
         <li>
            <a data-code="F811">
               ...
               <strong>F811:</strong> redefinition of unused 'pandas' from line 10
               
            </a>
            <ul class="details">
            <li>
               
               <a href="venv.Lib.site-packages.openai._extras.pandas_proxy.source.html#l28">
                  <tt><i>28</i>     <span class="n">pandas</span> <span class="o">=</span> <span class="n">PandasProxy</span><span class="p">()</span></tt>
               </a>
            </li>
            </ul>
         </li>
