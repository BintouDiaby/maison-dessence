...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\_lib\_gcutils.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy._lib._gcutils.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy._lib._gcutils.source.html#l9">
                  <tt><i>9</i> <span class="sd">   assert_deallocated - context manager to check for circular references on object</span></tt>
               </a>
            </li>
            </ul>
         </li>
