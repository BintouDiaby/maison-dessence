...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\_lib\tests\test_deprecation.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy._lib.tests.test_deprecation.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy._lib.tests.test_deprecation.source.html#l3">
                  <tt><i>3</i> <span class="nd">@pytest</span><span class="o">.</span><span class="n">mark</span><span class="o">.</span><span class="n">thread_unsafe</span></tt>
               </a>
            </li>
            </ul>
         </li>
