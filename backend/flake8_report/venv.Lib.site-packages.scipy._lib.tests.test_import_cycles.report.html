...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\_lib\tests\test_import_cycles.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy._lib.tests.test_import_cycles.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy._lib.tests.test_import_cycles.source.html#l11">
                  <tt><i>11</i> <span class="nd">@pytest</span><span class="o">.</span><span class="n">mark</span><span class="o">.</span><span class="n">fail_slow</span><span class="p">(</span><span class="mi">40</span><span class="p">)</span></tt>
               </a>
            </li>
            </ul>
         </li>
