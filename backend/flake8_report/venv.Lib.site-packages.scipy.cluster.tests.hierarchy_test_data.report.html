...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\cluster\tests\hierarchy_test_data.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.cluster.tests.hierarchy_test_data.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.cluster.tests.hierarchy_test_data.source.html#l75">
                  <tt><i>75</i>  </tt>
               </a>
            </li>
            </ul>
