...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\fft\_debug_backends.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.fft._debug_backends.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.fft._debug_backends.source.html#l3">
                  <tt><i>3</i> <span class="k">class</span><span class="w"> </span><span class="nc">NumPyBackend</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
