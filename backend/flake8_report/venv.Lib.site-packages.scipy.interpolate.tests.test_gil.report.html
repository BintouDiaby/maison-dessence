...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\interpolate\tests\test_gil.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.interpolate.tests.test_gil.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.interpolate.tests.test_gil.source.html#l64">
                  <tt><i>64</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
