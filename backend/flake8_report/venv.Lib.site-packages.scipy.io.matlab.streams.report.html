...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\io\matlab\streams.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.io.matlab.streams.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.io.matlab.streams.source.html#l9">
                  <tt><i>9</i> <span class="k">def</span><span class="w"> </span><span class="fm">__dir__</span><span class="p">():</span></tt>
               </a>
            </li>
            </ul>
         </li>
