...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\optimize\_cobyqa_py.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.optimize._cobyqa_py.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.optimize._cobyqa_py.source.html#l17">
                  <tt><i>17</i> <span class="sd">    Constrained Optimization BY Quadratic Approximations (COBYQA) algorithm [1]_.</span></tt>
               </a>
            </li>
            </ul>
         </li>
