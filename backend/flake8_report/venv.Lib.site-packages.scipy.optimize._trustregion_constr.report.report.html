...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\optimize\_trustregion_constr\report.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.optimize._trustregion_constr.report.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.optimize._trustregion_constr.report.source.html#l3">
                  <tt><i>3</i> <span class="k">class</span><span class="w"> </span><span class="nc">ReportBase</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
