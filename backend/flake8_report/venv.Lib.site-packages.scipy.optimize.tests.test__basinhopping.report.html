...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\optimize\tests\test__basinhopping.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.optimize.tests.test__basinhopping.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.optimize.tests.test__basinhopping.source.html#l201">
                  <tt><i>201</i>         <span class="c1"># Test 2-D minimizations with gradient. Nelder-Mead, Powell, COBYLA, and</span></tt>
               </a>
            </li>
            </ul>
         </li>
