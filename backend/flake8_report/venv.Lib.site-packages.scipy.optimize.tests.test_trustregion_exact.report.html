...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\optimize\tests\test_trustregion_exact.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.optimize.tests.test_trustregion_exact.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.optimize.tests.test_trustregion_exact.source.html#l351">
                  <tt><i>351</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
