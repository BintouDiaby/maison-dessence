...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\signal\_czt.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.signal._czt.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.signal._czt.source.html#l552">
                  <tt><i>552</i> <span class="sd">        plot(linspace(f1, f2, m, endpoint=False), abs(zoom_fft(x, [f1, f2], m)))</span></tt>
               </a>
            </li>
            </ul>
         </li>
