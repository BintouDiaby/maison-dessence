...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\signal\tests\test_cont2discrete.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.signal.tests.test_cont2discrete.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.signal.tests.test_cont2discrete.source.html#l349">
                  <tt><i>349</i> <span class="k">class</span><span class="w"> </span><span class="nc">TestC2dLti</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
