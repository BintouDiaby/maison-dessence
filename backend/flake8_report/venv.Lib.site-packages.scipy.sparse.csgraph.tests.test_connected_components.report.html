...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\sparse\csgraph\tests\test_connected_components.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.sparse.csgraph.tests.test_connected_components.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.sparse.csgraph.tests.test_connected_components.source.html#l119">
                  <tt><i>119</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
