...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\sparse\linalg\_isolve\tests\test_lsqr.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.sparse.linalg._isolve.tests.test_lsqr.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.sparse.linalg._isolve.tests.test_lsqr.source.html#l80">
                  <tt><i>80</i>             <span class="c1"># Check that the termination condition corresponds to an approximate</span></tt>
               </a>
            </li>
            </ul>
         </li>
