...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\sparse\linalg\_svdp.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.sparse.linalg._svdp.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.sparse.linalg._svdp.source.html#l171">
                  <tt><i>171</i>         <span class="k">raise</span> <span class="ne">ValueError</span><span class="p">(</span><span class="s2">&quot;`rng` must be a normalized numpy.random.Generator instance&quot;</span><span class="p">)</span></tt>
               </a>
            </li>
            </ul>
         </li>
