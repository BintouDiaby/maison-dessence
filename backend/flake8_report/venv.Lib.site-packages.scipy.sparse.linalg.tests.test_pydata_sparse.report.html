...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\sparse\linalg\tests\test_pydata_sparse.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.sparse.linalg.tests.test_pydata_sparse.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.sparse.linalg.tests.test_pydata_sparse.source.html#l130">
                  <tt><i>130</i>     <span class="n">X</span> <span class="o">=</span> <span class="n">x</span><span class="p">[:,</span><span class="kc">None</span><span class="p">]</span></tt>
               </a>
            </li>
            </ul>
         </li>
