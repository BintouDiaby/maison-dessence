...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\spatial\_procrustes.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.spatial._procrustes.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.spatial._procrustes.source.html#l132">
                  <tt><i>132</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
