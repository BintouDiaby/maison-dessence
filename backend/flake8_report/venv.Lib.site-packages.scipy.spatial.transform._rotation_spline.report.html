...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\spatial\transform\_rotation_spline.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.spatial.transform._rotation_spline.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.spatial.transform._rotation_spline.source.html#l245">
                  <tt><i>245</i>     <span class="n">l</span> <span class="o">=</span> <span class="mi">5</span></tt>
               </a>
            </li>
            </ul>
         </li>
