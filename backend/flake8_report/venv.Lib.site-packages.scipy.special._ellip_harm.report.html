...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\special\_ellip_harm.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.special._ellip_harm.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.special._ellip_harm.source.html#l142">
                  <tt><i>142</i> <span class="sd">    Lame functions of the second kind are related to the functions of the first kind:</span></tt>
               </a>
            </li>
            </ul>
         </li>
