...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\special\tests\test_pdtr.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.special.tests.test_pdtr.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.special.tests.test_pdtr.source.html#l28">
                  <tt><i>28</i> <span class="k">class</span><span class="w"> </span><span class="nc">TestPdtrc</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
