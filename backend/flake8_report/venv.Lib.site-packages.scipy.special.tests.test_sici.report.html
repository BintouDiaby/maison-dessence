...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\scipy\special\tests\test_sici.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.scipy.special.tests.test_sici.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.scipy.special.tests.test_sici.source.html#l15">
                  <tt><i>15</i>     </tt>
               </a>
            </li>
            </ul>
