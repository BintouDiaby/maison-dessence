...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\setuptools\tests\test_logging.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.setuptools.tests.test_logging.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.setuptools.tests.test_logging.source.html#l26">
                  <tt><i>26</i>     <span class="kn">import</span><span class="w"> </span><span class="nn">setuptools</span>  <span class="c1"># noqa: F401  # import setuptools to monkeypatch distutils</span></tt>
               </a>
            </li>
            </ul>
         </li>
