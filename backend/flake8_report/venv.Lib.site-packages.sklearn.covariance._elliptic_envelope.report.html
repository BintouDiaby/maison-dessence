...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\sklearn\covariance\_elliptic_envelope.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.sklearn.covariance._elliptic_envelope.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.sklearn.covariance._elliptic_envelope.source.html#l37">
                  <tt><i>37</i> <span class="sd">        be used within the algorithm: `(n_samples + n_features + 1) / 2 * n_samples`.</span></tt>
               </a>
            </li>
            </ul>
         </li>
