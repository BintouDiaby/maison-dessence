...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\sklearn\decomposition\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.sklearn.decomposition.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.sklearn.decomposition.__init__.source.html#l3">
                  <tt><i>3</i> <span class="sd">These include PCA, NMF, ICA, and more. Most of the algorithms of this module can be</span></tt>
               </a>
            </li>
            </ul>
         </li>
