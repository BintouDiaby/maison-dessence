...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\sklearn\linear_model\_perceptron.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.sklearn.linear_model._perceptron.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.sklearn.linear_model._perceptron.source.html#l13">
                  <tt><i>13</i> <span class="sd">    The implementation is a wrapper around :class:`~sklearn.linear_model.SGDClassifier`</span></tt>
               </a>
            </li>
            </ul>
         </li>
