...
<html>
   <head>
      <title>flake8 violations: .venv\Lib\site-packages\tqdm\auto.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.tqdm.auto.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.tqdm.auto.source.html#l27">
                  <tt><i>27</i>     <span class="k">class</span><span class="w"> </span><span class="nc">tqdm</span><span class="p">(</span><span class="n">notebook_tqdm</span><span class="p">,</span> <span class="n">asyncio_tqdm</span><span class="p">):</span>  <span class="c1"># pylint: disable=inconsistent-mro</span></tt>
               </a>
            </li>
            </ul>
         </li>
